        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row gx-3 row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-xl-4 row-cols-xxl-5">
                    ...
                    <div class="col">
                        <div class="card card-product-grid">
                            <a href="#" class="img-wrap"> <img src="assets/imgs/items/6.jpg" alt="Product" />
                            </a>
                            <div class="info-wrap">
                                <a href="#" class="title text-truncate">Haagen-Dazs Caramel Cone Ice</a>
                                <div class="price mb-2">$179.00</div>
                    ...
                    <div class="col">
                        <div class="card card-product-grid">
                            <a href="#" class="img-wrap"> <img src="assets/imgs/items/7.jpg" alt="Product" />
                            </a>
                            <div class="info-wrap">
                                <a href="#" class="title text-truncate">Haagen-Dazs Caramel Cone Ice</a>
                                <div class="price mb-2">$179.00</div>
                    ...
                    <div class="col">
                        <div class="card card-product-grid">
                            <a href="#" class="img-wrap"> <img src="assets/imgs/items/8.jpg" alt="Product" />
                            </a>
                            <div class="info-wrap">
                    ...
                    <div class="col">
                        <div class="card card-product-grid">
                            <a href="#" class="img-wrap"> <img src="assets/imgs/items/9.jpg" alt="Product" />
                            </a>
                            <div class="info-wrap">
                                <a href="#" class="title text-truncate">Apple Airpods CB-133</a>
                                <div class="price mb-2">$179.00</div>
                    ...
                    <div class="col">
                        <div class="card card-product-grid">
                            <a href="#" class="img-wrap"> <img src="assets/imgs/items/10.jpg" alt="Product" />
                            </a>
                            <div class="info-wrap">
                                <a href="#" class="title text-truncate">Apple Airpods CB-133</a>
                                <div class="price mb-2">$179.00</div>
